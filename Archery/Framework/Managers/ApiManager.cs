...
namespace Archery.Framework.Managers
{
    internal class ApiManager
    {
        ...
        {
            Archery.internalApi.RegisterSpecialAttack(Archery.manifest, "Snapshot", WeaponType.Bow, (arguments) => "Snapshot", (arguments) => "Fires two arrows in quick succession.", () => 3000, Snapshot.HandleSpecialAttack);
            Archery.internalApi.RegisterSpecialAttack(Archery.manifest, "Snipe", WeaponType.Any, (arguments) => "Snipe", (arguments) => "Instantly fires the projectile with increased speed. Guaranteed to critical hit.", () => 3000, Snipe.HandleSpecialAttack);
        }

...
namespace Archery.Framework.Interfaces.Internal
{
    public interface IApi
    {
        ...
        KeyValuePair<bool, string> RegisterEnchantment(IManifest callerManifest, string name, AmmoType whichAmmoTypeCanUse, TriggerType triggerType, Func<string> getDisplayName, Func<string> getDescription, Func<IEnchantment, bool> enchantmentHandler);
